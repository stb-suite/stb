#!/bin/bash
# Guided example: stb-kpath (code 1.3 in the stb-suite menu)
#
# Not an automated test (see test/1-inputs/3-k-path/test.sh for that) -- a
...
B -- interactive stb-suite menu:
  $ stb-suite
  Select an option (0-6, or a tool code like 4.1.2): 1.3

"1.3" asks for the structure file, then -- same "advanced settings" pattern
