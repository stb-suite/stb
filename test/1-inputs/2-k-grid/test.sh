...
echo "Testing: navigate 1.2 -> invalid file then valid -> invalid density then valid (0.2) -> quit"
...
echo "Testing: navigate 1.2 -> valid file -> press Enter for density (default: 0.2) -> quit"
