...
def run_hirshfeld_ions() -> None:
    ...
    print(color_text(
        ...
        "pick whichever one matches its own charge sign, per the literature. Hydrogen is the "
        "exception: its cation is a bare proton (no electrons), so only its anion folder is "
        "written and the cation reference is taken as zero density analytically.",
        'cyan'))
    print()
        ...
        'stages': {
            ...
            2: {'title': "Stage 2 - Ion Prep (stb-hirshfeldIons)",
                'description': "Write BOTH a cation and an anion reference folder for every "
                                "species (H: anion only, its cation is a bare proton) -- "
                                "Stage 3 lets each atom pick its own, per atom.",
