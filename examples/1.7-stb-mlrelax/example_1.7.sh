#!/bin/bash
# Guided example: stb-mlrelax (code 1.7 in the stb-suite menu)
#
# Not an automated test (see test/1-inputs/7-mlrelax/test.sh for that)
...
B -- interactive stb-suite menu:
  $ stb-suite
  Select an option (0-6, or a tool code like 4.1.2): 1.7
