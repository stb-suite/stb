...
`2.11-stb-amorphize/`, `2.12-stb-crystalcast/`, `3.1-stb-bands/`, `3.2-stb-dos/`,
`3.3-stb-convdos/`, `3.4-stb-structural/`) and are worth knowing once, rather than
...
| 2.6  | `stb-sqs`       | [`2.6-stb-sqs/`](2.6-stb-sqs/)              |
...
| 3.1  | `stb-bands`     | [`3.1-stb-bands/`](3.1-stb-bands/)          |
