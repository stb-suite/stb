#!/bin/bash
# Guided example: stb-dftu (code 1.4 in the stb-suite menu)
#
# Not an automated test (see test/1-inputs/4-dftu/test.sh for that) -- a
...
"1.4" itself offers two sub-modes: [1] read species off a structure file
